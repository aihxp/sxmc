...
| [VALIDATION_RUN_v2.0.0.md](VALIDATION_RUN_v2.0.0.md) | Maintainer validation for **2.0.0**: tests, smoke, benchmarks, JSON/stderr, MCP→CLI, `sxmc mcp`, `mcp session`, Cursor-style stdio check |
